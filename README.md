...
| **Хотелки** | Желания с ссылкой, ценой и картинкой; метаданные URL подтягиваются автоматически |
| **Траты** | Общие покупки с делением 50/50, категории, погашение долга, баланс «кто кому должен» |
| **Карты** | Электронные скидочные карты: номер, штрихкод/QR (рисуется на устройстве), логотип, сканер кода, опционально фото пластика. Документы (в т.ч. PDF) — во второй вкладке |
