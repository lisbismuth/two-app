...
**Лицензия:** [PolyForm Noncommercial 1.0.0](./LICENSE.md) — код открыт для просмотра, форков и некоммерческого использования; продавать нельзя.
...
[PolyForm Noncommercial 1.0.0](./LICENSE.md) — некоммерческая лицензия: можно смотреть, форкать и использовать в личных целях, продажа кода запрещена.
