...
- **Дела:** задачи с фильтрами (все / общие / по партнёру / готово), календарь и напоминания.
- **Хотелки:** общий вишлист с ссылками, ценами и авто-подтягиванием метаданных URL.
- **Траты:** трекер 50/50, категории, погашение долгов и баланс «кто кому должен».
...
- **Мы:** планы, капсулы времени, голосования и «мы»-статистика.
    ...
    <td width="35%" align="center" valign="middle">
      <img src="https://github.com/user-attachments/assets/d927cc93-e9e3-483b-aa7a-61d83da80834" width="200" alt="Демо работы приложения Двое">
    </td>
  </tr>
</table>
