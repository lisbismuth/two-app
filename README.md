    ...
    <td width="60%" valign="top">
      <table width="100%">
        ...
        <tbody>
          <tr>
            <td><b>Дела</b></td>
            <td>Задачи с фильтрами (все / общие / по партнёру / готово), повторяющиеся задачи, календарь</td>
          </tr>
          <tr>
            <td><b>Хотелки</b></td>
            <td>Общий вишлист с ссылками, ценами и авто-подтягиванием метаданных URL</td>
          </tr>
          <tr>
            <td><b>Траты</b></td>
            <td>Трекер трат 50/50, категории, погашение долгов и баланс «кто кому должен»</td>
          </tr>
          <tr>
            <td><b>Карты</b></td>
            <td>Скидочные карты (генерация QR/штрихкодов, сканер) и хранилище PDF</td>
          </tr>
          <tr>
            <td><b>Мы</b></td>
            <td>Планы, капсулы времени, голосования и «мы»-статистика</td>
          </tr>
        </tbody>
      </table>
    </td>
    <td width="40%" align="center" valign="top">
      <img src="https://github.com/user-attachments/assets/d927cc93-e9e3-483b-aa7a-61d83da80834" width="220" alt="Демо работы приложения Двое">
    </td>
  </tr>
</table>
